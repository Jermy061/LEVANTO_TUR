        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="px-5 py-2 bg-[#0077B6] text-white rounded-lg font-medium hover:bg-[#005F8F] transition-colors duration-200 shadow-md hover:shadow-lg">
                Login Admin
              </button>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200 bg-white animate-fade-in">
              <div className="flex flex-col space-y-4">
                ...
                <button className="px-5 py-2 bg-[#0077B6] text-white rounded-lg font-medium text-left">
                  Login Admin
                </button>
              </div>
            </div>
